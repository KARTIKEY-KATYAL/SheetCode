...
export function HowItWorks() {
  return (
    <section id="how-it-works" className=" h-[100vh] py-20 bg-gray-100 dark:bg-gradient-to-b dark:from-slate-900 dark:to-slate-950 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-primary to-primary/70 dark:from-sky-400 dark:to-indigo-400 bg-clip-text text-transparent flex items-center justify-center space-x-2">
            <span>How</span> <Logo size={34} /> <span>Works</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 lg:order-2 relative">
            <div className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-xl p-2 shadow-2xl shadow-primary/5 dark:shadow-sky-500/5 max-w-lg mx-auto overflow-hidden transform rotate-1 hover:rotate-0 transition-transform duration-700">
              <div className="bg-gray-100 dark:bg-slate-900 rounded-lg overflow-hidden">
                <div className="flex items-center bg-gray-200 dark:bg-slate-800 px-4 py-2 space-x-2">
                ...
                <div className="p-4 font-mono text-sm">
                  ...
                  <p className="text-gray-800 dark:text-slate-300 pl-4">
                  ...
                  <p className="text-gray-800 dark:text-slate-300 pl-8">
                  ...
                  <p className="text-gray-800 dark:text-slate-300 pl-12">
                    <span className="text-green-600 dark:text-green-300">...</span>
                  </p>
                </div>
                <div className="p-4 bg-gray-200/50 dark:bg-slate-800/50 mt-4 border-t border-gray-300 dark:border-slate-700">
                  <div className="flex justify-between text-sm">
                    <div className="text-gray-600 dark:text-slate-400">Time Complexity: O(n)</div>
                    <div className="text-green-600 dark:text-green-400 flex items-center"><CheckCircle2 className="h-4 w-4 mr-1" /> Tests Passed: 36/36</div>
                  </div>
                </div>
              </div>
            </div>
...
function Step({ number, title, description }: { number: string; title: string; description: string }) {
  return (
    <div className="flex items-start">
      <div className="bg-primary/10 text-primary dark:bg-sky-500/10 dark:text-sky-400 font-bold text-lg h-10 w-10 rounded-lg flex items-center justify-center mr-4 shrink-0">
        {number}
      </div>
      <div>
