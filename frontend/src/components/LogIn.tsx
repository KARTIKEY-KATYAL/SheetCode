    ...
    >
      ...
      <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-300 dark:border-gray-700">
        ...
        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
         ...
         <p className="mt-4 text-center text-sm font-bold text-gray-600 dark:text-gray-400">
          <a href="/signup" className="text-blue-500 hover:underline">Register Yourself</a>
        </p>
      </div>
    </div>
  )
